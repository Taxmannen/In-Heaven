...
//        {
//            bossShootSpreadShot = StartCoroutine(SpreadShootProjectile(SpreadShotBulletSpawnPosition, spreadShotStartingTarget));
//            //   bossShootSpreadShot = StartCoroutine(SpreadShotCorutine(SpreadShotBulletSpawnPosition, spreadShotStartingTarget));
//        }
//    }

//    private IEnumerator SpreadShootProjectile(Vector3 SpreadShotBulletSpawnPosition, float spreadShotStartingTarget)
//    {
//        if (timer >= 2)
//        {
//            //Vector3 angelPosition = GetComponent<Rigidbody>().position;

//            //GameObject spreadShotProjectile = Instantiate(SpreadShotProjectile, angelPosition, Quaternion.identity);
//            //Destroy(spreadShotProjectile, 1f);

//            //spreadShotProjectile.GetComponent<Rigidbody>().velocity += (SpreadShotBulletSpawnPosition - angelPosition) * SpreadShotProjectileSpeed;
...
//            Vector3 SpreadShotTarget = new Vector3(spreadShotStartingTarget + x, 1, 0) - SpreadShotBulletSpawnPosition;
